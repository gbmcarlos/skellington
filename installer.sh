...
if [ "$#" -lt 1 ]; then
    cat <<End-of-message
Usage: curl -s -L https://raw.githubusercontent.com/gbmcarlos/skellington/laravel/installer.sh | bash /dev/stdin <project name> [<GitHub username>]
...
curl -s -L https://github.com/gbmcarlos/skellington/tarball/laravel | tar xz --strip 1
