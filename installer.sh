...
if [ "$#" -lt 1 ]; then
    cat <<End-of-message
Usage: curl -s -L https://raw.githubusercontent.com/gbmcarlos/skellington/swoole/installer.sh | bash /dev/stdin <project name> [<GitHub username>]
